...
function Header() {
    ...
    function toggleGamesMenu(event) {
        const gamesLink = document.querySelector('.games-links');
        gamesLink?.classList.contains('hover') ? gamesLink?.classList.remove('hover') : gamesLink?.classList.add('hover') 
    }

    return (
            <header className="main-homepage-header">
                <nav className="main-header-nav">
                    <ul className="main-header-menu">
                        ...
                        <li>
                            <Link to="/wallpainter">Wallpaper</Link>
                        </li>
                        <li>
                            <Link to="/ip">IP</Link>
                        </li>
                        <li className="games-links" onClick={toggleGamesMenu}>
                            <a>Games</a>
                            <ul>
                                <div className="games-links-close-btn">X</div>
                                <Link to='game-of-life'>GOL</Link>
                                <Link to='Bomb'>Bomb</Link>
                            </ul>
                        </li>
                        <li>
                            <Link to="mailto:eric@ericmurphy.xyz">Exchange</Link>
                        </li>
                        <li>
                    ...
                    <li>
                        <a href="https://github.com/sajadEng" target="_blank" rel="noopener noreferrer">
                    ...
                    <li>
                        <a href="https://t.me/sajiFe" target="_blank" rel="noopener noreferrer">
