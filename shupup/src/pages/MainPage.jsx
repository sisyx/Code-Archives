        ...
        <div className={styles.container}>
            <div className={styles.grouping}>
                <div className={styles.groups}>
                    <div className={styles.group}>لباس</div>
                    <div className={styles.group}>محصولات آرایشی</div>
                    <div className={styles.group}>اکسسوری</div>
                </div>
            ...
            <main className={styles.main}>
                <div className={styles.left_side}>
                    ...
                    <div className={styles.products}>
                        {
                            filteredProducts.map(product => <OffProductCard product={product} bg='rgba(0, 0, 0, 0.25);' />)
                        }
                    </div>
                </div>
                <div className={styles.filters}>
                    ...
                    <Dropdown data={{name: 'کشور', options: countries}} handler={handleFilterCountry} /> 
