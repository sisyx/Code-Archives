    ...
    return (
        <header className={`${styles.header} ${isSearching ? styles.space_between : ''}`}>
            ...
            <div className={styles.left}>
                ...
                <div className={`${styles.search} ${isSearching ? styles.active_search : ''}`}>
                    ...
                    <input className={`${styles.search_input} id="searchinput" ${isSearching ? '' : styles.hidden}`} placeholder='Search' onBlur={toggleIsSearching} />
                </div>
            </div>
